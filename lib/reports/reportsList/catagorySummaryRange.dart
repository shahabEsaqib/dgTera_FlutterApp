...
class CatagorySummary extends StatelessWidget {
  const CatagorySummary({
    Key? key,
  }) : super(key: key);
          ...
          children: [
            ...
            Padding(
              ...
              Container(
                ...
                child: Center(child: Text("Product Mix",style: TextStyle(fontSize: 50,fontWeight: FontWeight.bold),)),
              ),
              SizedBox(height: 30,),
              Row(children: [
                Container(
              ...
              Row(children: [
                Container(
                  width:250,
                  // height: 40,
                  child: Text("Totle # Order",style: TextStyle(fontWeight: FontWeight.bold,fontSize:25))),
                SizedBox(width: 8,),
                Container(
                  width: 350,
                  // height: 40,
                  child: Text(":0",style: TextStyle(fontWeight: FontWeight.bold,fontSize:25))),
              ],),
              SizedBox(height: 4,),
              Container(
              width: MediaQuery.of(context).size.width,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Totle Discount",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Totle net",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,),),
